...
export default class C_AddendumForm extends Component {
                    ...
                    <div className="App-Holder col-lg-8 col-md-11">
                        ...
                        <Form noValidate={true} onChange={resetError}>
                            ...
                            <div className={"mt-5 text-center"}>
                                <input type={"submit"} disabled={isSubmitting || error_submit!== "standing by"} value={"Add Addendum"} className={"btn btn-yellow"}/>
