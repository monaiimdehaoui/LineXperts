...
import AddendumHandler from "../../Requests/AddendumHandler";

//Page presenting client's information, contracts and addendums

export default class ClientResultPageAdd extends Component{
    constructor(props) {
        super(props);
        this.state ={
            client_data:{},
    ...
    render(){
        ...
        return(
            <div className="App-Holder col-lg-8 col-md-11">
                ...
                {error_submit === "success" ? <AddendumHandler id={client_data.clientId}/>
                : <></>}

                <div className={"row mt-5"}>
                    <Link to={`/add-addendum/${client_data.clientId}`}>
